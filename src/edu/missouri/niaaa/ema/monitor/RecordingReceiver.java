...
//			if(!(MonitorUtilities.isToSendDataEmpty())){
//				transmitData.execute(enformattedData);
//			}
//			else{
//				ArrayList<String> toSendData = MonitorUtilities.getToSendData();
//			
//				for(String value : toSendData){
//					transmitData.execute(value);
//				}
//				
//				Boolean toSendDataClear = MonitorUtilities.clearToSendData();
//				
//				if(!toSendDataClear)
//					MonitorUtilities.clearToSendData();
//				
//			}
//		}
//		else {
//			MonitorUtilities.addToSendData(enformattedData);
//  		}
// 
