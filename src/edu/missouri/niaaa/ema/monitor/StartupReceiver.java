...
public class StartupReceiver extends BroadcastReceiver {
	private final String TAG = "Startup Receiver";
	...
	public void onReceive(Context context, Intent intent) {
		...
		String toWrite = MonitorUtilities.getCurrentTimeStamp() + MonitorUtilities.LINEBREAK + "Device was turned ON by user! And just finished booting."
